...
void Trinity::Banner::Show(char const* applicationName, void(*log)(char const* text), void(*logExtraInfo)())
{
    ...
    log(" ");
    log("Project Resurrected by The Legion Emulation Project.");
    log("https://github.com/LegionEmulationProject.");
    log(" ");
    log("If you paid for this. Get a refund. This project is free.");
    log(" ");
    log(" ");
