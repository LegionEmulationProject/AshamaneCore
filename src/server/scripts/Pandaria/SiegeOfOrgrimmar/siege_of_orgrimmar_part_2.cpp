...
class npc_siege_of_orgrimmar_jaina_proudmoore_2 : public CreatureScript
{
    public:
        ...
        {
            npc_siege_of_orgrimmar_jaina_proudmoore_2AI(Creature* creature) : ScriptedAI(creature)
            {
                me->setActive(true);
...
class npc_siege_of_orgrimmar_king_varian_wrynn_2 : public CreatureScript
{
    public:
        ...
        {
            npc_siege_of_orgrimmar_king_varian_wrynn_2AI(Creature* creature) : ScriptedAI(creature)
            {
                me->setActive(true);
                me->SetReactState(REACT_PASSIVE);
...
class npc_siege_of_orgrimmar_lorthemar_theron_2 : public CreatureScript
{
    public:
        ...
        {
            npc_siege_of_orgrimmar_lorthemar_theron_2AI(Creature* creature) : ScriptedAI(creature)
            {
                me->setActive(true);
                me->SetReactState(REACT_PASSIVE);
...
class npc_siege_of_orgrimmar_sylvanas_windrunner_2 : public CreatureScript
{
    public:
        ...
        {
            npc_siege_of_orgrimmar_sylvanas_windrunner_2AI(Creature* creature) : ScriptedAI(creature)
            {
                me->setActive(true);
                me->SetReactState(REACT_PASSIVE);
...
class npc_siege_of_orgrimmar_aethas_sunreaver : public CreatureScript
{
    public:
        ...
        {
            npc_siege_of_orgrimmar_aethas_sunreaverAI(Creature* creature) : ScriptedAI(creature)
            {
                me->setActive(true);
                me->SetReactState(REACT_PASSIVE);
    ...
    public:
        ...
        struct npc_siege_of_orgrimmar_hellscream_demolisherAI : public Scripted_NoMovementAI
        {
            npc_siege_of_orgrimmar_hellscream_demolisherAI(Creature* creature) : Scripted_NoMovementAI(creature)
            {
                ...
                me->SetFloatValue(UNIT_FIELD_BOUNDINGRADIUS, 5.f);
                me->SetFloatValue(UNIT_FIELD_COMBATREACH, 5.f);
            }
