/*
 * Copyright (C) 2017-2026 AshamaneProject <https://github.com/AshamaneProject>
...
public:
    ...
    {
        instance_eye_of_azshara_InstanceMapScript(InstanceMap* map) : InstanceScript(map), _deadArcanistCount(0), _deadBossCount(0), _deadNagasCount(0)
        {
