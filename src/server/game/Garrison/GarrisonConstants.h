...
{
    GARR_BUILDING_TYPE_NONE         = 0,
    GARR_BUILDING_TYPE_MINE         = 1,
    GARR_BUILDING_TYPE_HERB_GARDEN  = 2,
    GARR_BUILDING_TYPE_BARN         = 3,
    GARR_BUILDING_TYPE_LUMBER_MILL  = 4,
    GARR_BUILDING_TYPE_TAVERN       = 5,
    GARR_BUILDING_TYPE_TRADING_POST = 6,
    GARR_BUILDING_TYPE_MENAGERIE    = 7,
    GARR_BUILDING_TYPE_BARRACKS     = 8,
    GARR_BUILDING_TYPE_WARMILL      = 10,
    GARR_BUILDING_TYPE_STABLES      = 11,
    GARR_BUILDING_TYPE_MAGETOWER    = 13,
    GARR_BUILDING_TYPE_SALVAGE_YARD = 14,
    GARR_BUILDING_TYPE_STOREHOUSE   = 15,
    GARR_BUILDING_TYPE_ALCHEMY_LAB  = 16,
    GARR_BUILDING_TYPE_FORGE        = 17,
    GARR_BUILDING_TYPE_ENCHANTERS   = 18,
    GARR_BUILDING_TYPE_ENGINEERING  = 19,
    GARR_BUILDING_TYPE_SCRIBE       = 20,
    GARR_BUILDING_TYPE_GEM          = 21,
    GARR_BUILDING_TYPE_TANNERY      = 22,
    GARR_BUILDING_TYPE_TAILORING    = 23,
    GARR_BUILDING_TYPE_FISHING      = 24,
    GARR_BUILDING_TYPE_GLADIATORS   = 25,
    GARR_BUILDING_TYPE_WORKSHOP     = 26,
    GARR_BUILDING_TYPE_MAX
};
