...
bool Creature::LoadCreaturesAddon()
{
    ...
    // No hacer nada con los nuevos campos - dejar valores por defecto
    // Las funciones SetAnimTier(), SetStandState(), etc no existen en Legion
    // Solo cargar mount y emote que son seguros
