...
UPDATE `creature` SET `position_x` = -2347.824219, `position_y` = -11363.384766, `position_z` = 27.942247, `orientation` = 1.895, `wander_distance` = 0, `MovementType` = 0 WHERE `guid` = 62369;
UPDATE `creature` SET `position_x` = -2571.970459, `position_y` = -11343.209961, `position_z` = 25.304287, `wander_distance` = 10, `MovementType` = 1 WHERE `guid` = 62370;
UPDATE `creature` SET `position_x` = -2551.867188, `position_y` = -11275.340820, `position_z` = 36.856060, `wander_distance` = 10, `MovementType` = 1 WHERE `guid` = 62391;
UPDATE `creature` SET `position_x` = -2442.700684, `position_y` = -11346.622070, `position_z` = 30.975761, `wander_distance` = 10, `MovementType` = 1 WHERE `guid` = 62356;
UPDATE `creature` SET `position_x` = -2331.138184, `position_y` = -11346.259766, `position_z` = 30.188799, `wander_distance` = 10, `MovementType` = 1 WHERE `guid` = 62388;
UPDATE `creature` SET `position_x` = -2394.431396, `position_y` = -11369.132813, `position_z` = 30.477755, `wander_distance` = 10, `MovementType` = 1 WHERE `guid` = 62387;
UPDATE `creature` SET `position_x` = -2418.719727, `position_y` = -11211.605469, `position_z` = 24.287613, `wander_distance` = 0,  `MovementType` = 0 WHERE `guid` = 62399;
...
UPDATE `creature` SET `wander_distance` = 0, `MovementType` = 0 WHERE `guid` IN (62394,62357,62404,62368,62403,62397,62399,62396,62365,62366,62382,62372,62389,62355,62378,62382,62373,62379);

-- Waypoints & Text for Boss
UPDATE `creature` SET `position_x` = -2542.234375, `position_y` = -11328.796875, `position_z` = 22.867491, `orientation` = 0.662011, `wander_distance` = 0, `MovementType` = 0, `spawntimesecs` = 120 WHERE `guid` = 84399;
