...
(26, 5654, 7505, 0, 0, 47, 0, 40740, 64, 0, 1, 'Allow phase 5654 if Quest (40740) IS NOT rewarded'),
(26, 5654, 7505, 0, 0, 47, 0, 40930, 64, 0, 1, 'Allow phase 5654 if Quest (40930) IS NOT rewarded');
...
INSERT INTO `creature_addon` (`guid`, `path_id`, `mount`, `StandState`, `AnimTier`, `emote`, `aiAnimKit`, `movementAnimKit`, `meleeAnimKit`, `visibilityDistanceType`, `auras`) VALUES
...
(@CGUID+6, 0, 0, 0, 0, 0, 0, 0, 0, 0, ''), -- 93471
(@CGUID+7, 0, 0, 0, 0, 0, 0, 0, 0, 0, ''), -- 104091
(@CGUID+8, 0, 0, 0, 3, 0, 0, 0, 0, 0, ''), -- 93471
...
(@CGUID+15, 0, 0, 0, 3, 0, 0, 0, 0, 0, ''), -- 93471
(@CGUID+16, 0, 0, 0, 0, 0, 0, 0, 0, 0, ''), -- 93471
(@CGUID+17, 0, 0, 0, 3, 0, 0, 0, 0, 0, ''), -- 93471
