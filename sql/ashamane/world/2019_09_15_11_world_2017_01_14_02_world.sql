...
INSERT INTO `creature` (guid, id, map, spawnDifficulties, phaseId, phaseGroup, phaseUseFlags, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecs, wander_distance, currentwaypoint, curhealth, curmana, MovementType) VALUES 
-- Exodar Invisible stalker
(@GUID_1,18814,530,'0',0,0,0,0,0,-3669.94,-11450.8,-114.348,4.31096,300,0,0,42,0,0);

-- Hobahken
UPDATE `creature` SET `wander_distance` = 0, `MovementType` = 0 WHERE `guid` = 63013;
-- Hobahken SAI
SET @ENTRY := 17519;
